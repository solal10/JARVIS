...
export const metadata = {
  title: "Services — SARL JARVIS",
  description: "Découvrez nos services de développement logiciel, intégration matériel et support continu pour votre entreprise à Monaco.",
};
