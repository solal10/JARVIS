...
export const metadata = {
  title: "Solutions Web-Marketing France | SEO & Campagnes Digitales | JARVIS",
  description: "Expert web-marketing : stratégie digitale, SEO référencement, campagnes publicitaires, analytics. Agence marketing digital pour entreprises avec interventions dans toute la France.",
};
          ...
          <div className="max-w-screen-md mx-auto">
            ...
            <div className="max-w-screen-md mx-auto mt-20 pt-12 border-t border-jarvisGold/30">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  <h4 className="text-xl font-semibold mb-3 text-white">Création de Sites Internet</h4>
                  <p className="text-white/80">Développement de sites performants optimisés pour le SEO et la conversion marketing.</p>
                </a>
                <a
                ...
                >
                  ...
                  <p className="text-white/80">Maintenance de votre présence digitale avec suivi des performances marketing.</p>
                </a>
              </div>
            </div>
          </div>
