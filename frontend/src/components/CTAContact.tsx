  ...
  return (
    <section className={`py-20 md:py-24 text-white relative overflow-hidden ${className}`}>
      <div className="container mx-auto px-6 relative z-10">
        <motion.div
          className="max-w-4xl mx-auto backdrop-blur-sm p-10 md:p-12 rounded-xl border border-jarvisGold/50 shadow-2xl overflow-hidden relative"
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.7 }}
          viewport={{ once: true }}
        >
          {/* Éléments décoratifs internes pour éviter le débordement */}
          <motion.div 
          ...
          <div className="text-center">
            ...
            <motion.div 
              className="mt-8 flex flex-col sm:flex-row flex-wrap justify-center gap-4 sm:gap-8 text-white/70 items-center"
              initial={{ opacity: 0 }}
              whileInView={{ opacity: 1 }}
