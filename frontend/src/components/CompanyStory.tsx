      ...
      <div className="container mx-auto">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-white/80">
            ...
            <p className="text-lg leading-relaxed">
              Basés à Monaco, nous intervenons pour des clients du monde entier, avec une attention particulière
              portée à la qualité de service et à la satisfaction client. Notre approche personnalisée nous permet
              de créer des relations durables avec nos partenaires.
            </p>
          </div>
        </div>
      </div>
